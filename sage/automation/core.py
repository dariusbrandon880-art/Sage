...
class AutomationScheduler:
    ...
    def schedule_job(self, name: str, job_callable: Callable[[], Any], interval_seconds: int = 60) -> None:
    ...
    def heal(self) -> bool:
        ...
        if action == "remediate_blockers":
            ...
            for blocker in blockers:
                if "temporary" in blocker.lower() or "minor" in blocker.lower() or "timeout" in blocker.lower():
