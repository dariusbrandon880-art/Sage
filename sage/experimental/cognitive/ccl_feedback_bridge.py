...
class CCLFeedbackRecord(BaseModel):
    """Immutable feedback record produced by the CCL outcome bridge."""
...
class CCLOutcomeFeedbackBridge:
    """Feeds execution outcomes into the adaptive mission-selection failure history."""
    ...
    def process_outcome(
        ...
        record = CCLFeedbackRecord(
            ...
            causal_attribution=causal_attribution or {},
        )
    ...
    def get_failure_history(self) -> List[Dict[str, Any]]:
        return [
            ...
            if record.outcome_status in {"FAIL", "DRIFT_DETECTED"}
        ]
