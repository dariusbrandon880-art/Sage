...
class C2WavePlaybookEngine:
    """Records wave executions and derives bounded optimization patterns from history."""
    ...
    def suggest_optimization_pattern(self) -> WaveOptimizationPattern:
        ...
        top_frontiers = sorted(frontier_counts, key=frontier_counts.get, reverse=True)[:5]
