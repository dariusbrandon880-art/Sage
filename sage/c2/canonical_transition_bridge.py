...
class CanonicalC2TransitionBridge:
    ...
    def apply(self, response: SAGEStructuredResponse) -> C2TransitionResult:
        ...
        bond_payload = {
            ...
            "metadata": {"action_type": action.value, "runtime_action": runtime_action, "parameter": value, "target": CANONICAL_TARGET},
        }
        try:
        ...
        return C2TransitionResult(True, action.value, runtime_action, transition_id, refs, before, after)
