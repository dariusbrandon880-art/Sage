...
class LiveOperationReceipt:
    ...
    def verify(self, attestation: AttestationProvider | None = None) -> bool:
        ...
        # Verify source cryptographic signature
...
def persist_live_operation_receipt(receipt: LiveOperationReceipt, path: str | Path, attestation: AttestationProvider | None = None) -> None:
...
def rehydrate_live_operation_receipt(path: str | Path, attestation: AttestationProvider | None = None) -> LiveOperationReceipt:
