...
| #248 | Command Fidelity + Reality Gate | `command_fidelity_wave.py`, `directive_fidelity.py`, `reality_gate.py`, `claim_provenance.py`, `drift_sentinel.py` absent | Reconstructed |

## Confirmed surviving fronts

The following sampled historical fronts were checked for their substantive implementation paths and found represented on current `main`: #251 live-operation receipts, #250 ChatGPT C2 contract, #247/#246 fleet concurrency and failure intelligence, #244 authorization/frontier intelligence, #242/#253 multi-frontier dispatch, #238/#233 runtime/cognitive integration, #229 runtime engine, and #235 longitudinal flight tooling.
