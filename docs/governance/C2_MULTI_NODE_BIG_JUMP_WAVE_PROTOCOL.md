...
## 2. Multi-Node Architecture Model
...
### Law 1: Node Autonomy with Bounded Scope
Each Jules Node (Node A, Node B, Node C) operates as a complete, independent execution unit capable of running a full **5-Flight Big Jump Wave** with 2 reserve capacity slots (up to 7 flight units total).
...
```json
{
  ...
  "nodes": {
    "NODE_A": {
      "role": "PRIMARY_REPAIR_WAVE",
      "active_flights": ["F1", "F2", "F3", "F4", "F5"],
      "reserve_slots": ["R1", "R2"]
    },
    "NODE_B": {
      "role": "INDEPENDENT_VERIFICATION_WAVE",
      "active_flights": ["F1", "F2", "F3", "F4", "F5"],
      "reserve_slots": ["R1", "R2"]
    },
    "NODE_C": {
      "role": "ADVERSARIAL_RESEARCH_WAVE",
      "active_flights": ["F1", "F2", "F3", "F4", "F5"],
      "reserve_slots": ["R1", "R2"]
    }
  }
