#!/usr/bin/env python3
"""Execute Execution Intelligence as an explicit mission set.
...
def main():
    ...
    receipt = WorkflowVelocityController().execute_execution_intelligence_wave(
        wave_id="wave_execution_intelligence_v1", exact_git_head=head_sha,
        flights=flights, requested_workers=4,
    )
