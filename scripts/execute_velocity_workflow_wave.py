    ...
    flight_payloads = [
        {
            ...
            "pr_or_change": "PR #270",
            "executor": lambda: {"execution_result": "PASS", "tests_passed": 12},
        },
        {
            "flight_id": "F2",
            ...
            "pr_or_change": "PR #271",
            "executor": lambda: {"execution_result": "PASS", "tests_passed": 15},
        },
        {
            "flight_id": "F3",
        ...
        },
        {
            ...
            "pr_or_change": "PR #273",
            "executor": lambda: {"execution_result": "PASS", "tests_passed": 20},
        },
        {
            "flight_id": "F5",
            ...
            "pr_or_change": "PR #274",
            "executor": lambda: {"execution_result": "PASS", "tests_passed": 14},
        },
    ]
