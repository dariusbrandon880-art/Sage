...
def verify_render_chatgpt_action(base_url: str = None, api_key: str = None, target_root: Path = None):
    ...
    # Action status determination: Require live HTTPS + all passed
    if verification_passed and is_live_https:
        action_status = "CONNECTED_AND_GOVERNED"
    elif is_mock_or_local and verification_passed:
    ...
    evidence = {
        ...
        "verification_passed": verification_passed and is_live_https,
