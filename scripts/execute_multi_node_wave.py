...
Executes a canonical 3-node Big Jump Wave (Nodes A, B, C) with 5 independent flights
+ 2 reserve slots per node, generating signed evidence in evidence_capture/multi_node_wave_evidence.json.
"""
...
def main():
    ...
    logger.info(f"Multi-Node Big Jump Wave completed successfully.")
