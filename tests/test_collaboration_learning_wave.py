"""Fail-closed anti-drift validation for SAGE Governed Collaboration Learning Wave."""
...
def test_collaboration_learning_wave_evidence_exists_and_valid():
    evidence_path = Path("evidence_capture/collaboration_learning_wave_evidence.json")
    assert evidence_path.exists(), "Collaboration learning wave evidence file must exist."
    ...
    # Rule 5: Exact 40-character commit SHA binding
