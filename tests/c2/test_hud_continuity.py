...
def test_unchanged_hud_retains_update_key_without_suppression() -> None:
    ...
    assert repeated.previous_hud_update_key == response.hud_update_key
...
def test_hud_visible_false_preserves_canonical_hud_and_name_tag() -> None:
