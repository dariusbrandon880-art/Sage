"""Fail-closed anti-drift validation for SAGE Operational Maturity Wave."""
...
def test_operational_maturity_wave_evidence_exists_and_valid():
    evidence_path = Path("evidence_capture/operational_maturity_wave_evidence.json")
    assert evidence_path.exists(), "Operational maturity wave evidence file must exist."
