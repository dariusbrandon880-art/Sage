"""Fail-closed anti-drift validation for SAGE Flight GPS Control Plane Wave."""
...
def test_flight_gps_control_plane_wave_evidence_exists_and_valid():
    evidence_path = Path("evidence_capture/flight_gps_control_plane_wave_evidence.json")
    assert evidence_path.exists(), "Flight GPS control plane wave evidence file must exist."
