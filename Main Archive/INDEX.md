...
- [SAGE Validation and Evidence Lifecycle Layer](../docs/master/VALIDATION_LIFECYCLE.md) - Specification of the verification framework and evidence lifecycle state machine.
